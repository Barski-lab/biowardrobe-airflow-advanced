...
GIT_VERSION_FILE = path.join('biowardrobe_airflow_advanced', '.git_version')
...
setup(
    name='biowardrobe-airflow-advanced',
    description="BioWardrobe Airflow Advanced Analysis",
    long_description=open(path.join(path.dirname(__file__), 'README.md')).read(),
    long_description_content_type="text/markdown",
    version=get_version(),
    url='https://github.com/Barski-lab/biowardrobe-airflow-advanced',
    download_url='https://github.com/Barski-lab/biowardrobe-airflow-advanced',
